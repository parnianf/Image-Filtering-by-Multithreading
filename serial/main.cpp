...
vector<vector<vector<int>>> sepia_pixels;
...
vector<vector<vector<int>>> washed_pixels;
...
int main(int argc, char *argv[])
{
    ...
    sepia_pixels.resize(rows + 1, vector<vector<int>>(cols + 1, vector<int>(3)));
    washed_pixels.resize(rows + 1, vector<vector<int>>(cols + 1, vector<int>(3)));
